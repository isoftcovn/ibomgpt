...
class Home1Screen extends React.PureComponent<IProps, IState> {
    ...
    render() {
        return (
            <ExtendedView showsVerticalScrollIndicator={false} bounces={false}>
                <LanguageText style={theme.textVariants.body1}>Home screen 1</LanguageText>
...
export default connect(mapStateToProps, actions)(Home1Screen);
